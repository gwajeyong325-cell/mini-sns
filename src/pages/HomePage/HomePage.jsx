...
const MOCK_STUDIES = [
  { id: '1', title: 'UIUX 포트폴리오 스터디 4기 모집', category: 'UIUX', tags: ['#UIUX', '#포트폴리오', '#취업준비'], post_type: 'study', study_mode: 'both', location: '대구', max_members: 8, current_members: 5, deadline: '2026-06-30', status: 'open', likes_count: 24, image_url: 'https://images.unsplash.com/photo-1561070791-2526d30994b5?w=800', users: { display_name: '디자인멘토', avatar_url: '' } },
  { id: '2', title: '브랜드 아이덴티티 디자인 스터디', category: '브랜딩', tags: ['#브랜딩', '#로고', '#아이덴티티'], post_type: 'study', study_mode: 'online', location: '온라인', max_members: 6, current_members: 5, deadline: '2026-06-20', status: 'closing', likes_count: 18, image_url: 'https://images.unsplash.com/photo-1558655146-9f40138edfeb?w=800', users: { display_name: '브랜드마스터', avatar_url: '' } },
  { id: '3', title: '영상편집 & 모션그래픽 입문 스터디', category: '영상편집', tags: ['#영상편집', '#모션', '#애프터이펙트'], post_type: 'study', study_mode: 'online', location: '온라인', max_members: 10, current_members: 7, deadline: '2026-07-15', status: 'open', likes_count: 31, image_url: 'https://images.unsplash.com/photo-1536240478700-b869ad10e128?w=800', users: { display_name: '모션크리에이터', avatar_url: '' } },
  { id: '4', title: '디지털 마케팅 & SNS 운영 스터디', category: '마케팅', tags: ['#마케팅', '#SNS', '#콘텐츠'], post_type: 'study', study_mode: 'offline', location: '서울', max_members: 5, current_members: 5, deadline: '2026-06-10', status: 'closed', likes_count: 45, image_url: 'https://images.unsplash.com/photo-1432888498266-38ffec3eaf0a?w=800', users: { display_name: '마케터박', avatar_url: '' } },
  { id: '5', title: '그래픽 디자인 포트폴리오 완성반', category: '그래픽', tags: ['#그래픽', '#일러스트레이터', '#포토샵'], post_type: 'study', study_mode: 'both', location: '부산', max_members: 8, current_members: 3, deadline: '2026-07-31', status: 'open', likes_count: 15, image_url: 'https://images.unsplash.com/photo-1541462608143-67571c6738dd?w=800', users: { display_name: '그래픽고수', avatar_url: '' } },
];

const MOCK_POSTS = [
  { id: 'p1', title: '피그마 오토레이아웃 꿀팁 공유합니다', caption: '오토레이아웃을 제대로 활용하면 디자인 속도가 2배는 빨라져요. 제가 실무에서 쓰는 꿀팁들을 공유해 드릴게요!', category: 'UIUX', tags: ['#피그마', '#UIUX', '#꿀팁'], post_type: 'feed', likes_count: 42, comments_count: 8, created_at: new Date(Date.now() - 3600000).toISOString(), image_url: 'https://images.unsplash.com/photo-1609921212029-bb5a28e60960?w=800', users: { display_name: 'UX리서처김', avatar_url: '' } },
  { id: 'p2', title: '브랜딩 프로젝트 후기 — 로컬 카페 리브랜딩', caption: '3개월간 진행한 로컬 카페 리브랜딩 프로젝트 후기입니다. 처음부터 끝까지 혼자 진행하면서 많이 배웠어요.', category: '브랜딩', tags: ['#브랜딩', '#리브랜딩', '#포트폴리오'], post_type: 'feed', likes_count: 89, comments_count: 21, created_at: new Date(Date.now() - 7200000).toISOString(), image_url: 'https://images.unsplash.com/photo-1559056199-641a0ac8b55e?w=800', users: { display_name: '브랜드디자이너이', avatar_url: '' } },
